...
var EigenDAAdapter_1 = require("./packages/EigenDAAdapter");
dotenv.config();
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var eigenDA, balance, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    eigenDA = new EigenDAAdapter_1.EigenDAAdapter({
                    ...
                    return [4 /*yield*/, eigenDA.initialize()];
                case 2:
                    _a.sent();
                    console.log('✅ Initialization successful');
                    console.log('Checking balance...');
                    return [4 /*yield*/, eigenDA.getBalance()];
                case 3:
                    balance = _a.sent();
