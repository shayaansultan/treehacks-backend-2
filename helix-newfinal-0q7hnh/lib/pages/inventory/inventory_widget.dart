...
class _InventoryWidgetState extends State<InventoryWidget>
  ...
  void initState() {
    ...
    _model.textController ??= TextEditingController(text: 'Input Drug Name');
                                  ...
                                  child: Container(
                                    ...
                                    child: Stack(
                                      children: [
                                        ...
                                        Align(
                                          alignment:
                                              AlignmentDirectional(-0.23, 0.74),
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              context.pushNamed('Loading');
                                            },
                                            text: 'Request New Drug',
                                        ...
                                        children: [
                                          ...
                                          ClipRRect(
                                            ...
                                            child: SvgPicture.asset(
                                              'assets/images/chart_green_exchange.svg',
                                              width: 100.0,
                                              height: 40.0,
                                              fit: BoxFit.cover,
                                            ),
                                      ...
                                      children: [
                                        ...
                                        ClipRRect(
                                          borderRadius:
                                              BorderRadius.circular(8.0),
                                          child: Image.asset(
                                            'assets/images/chart_red_exchange.png',
                                            width: 100.0,
                                            height: 40.0,
                                            fit: BoxFit.cover,
                                          ),
